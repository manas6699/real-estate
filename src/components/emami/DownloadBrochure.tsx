...
export default function DownloadBrochure() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            link.href = 'pdfs/Emami Brochure.pdf'; // Path in the public folder
            link.download = 'Emami-Aamod-Brochure.pdf'; // Suggested filename
            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-10 p-6 md:p-20 mb-10">
                ...
                <div className="flex-1">
                    <p className="font-semibold text-gray-600 text-sm md:text-base leading-relaxed">
                        Download our brochure to explore the exquisite features and amenities.
