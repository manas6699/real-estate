...
export default function DownloadBrochureButton2({ source, pdfurl, btnText } : sourceType) {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            // ✅ Reset form and UI AFTER download
            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-10">
                ...
                >
                    ...
                    <div className="flex flex-col leading-tight text-left">
                        ...
                        <span className="text-sm md:text-base font-semibold">{btnText}</span>
                    </div>
                </button>
            ...
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
                    <div className="bg-white rounded-2xl w-[90%] max-w-md p-6 md:p-8 shadow-lg relative">
                        ...
                        {/* Modal Content */}
                        <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-4">Download {btnText}</h2>
