...
const STATUS_MAPPING: Record<string, { disposition: string; category: string }> = {
    ...
    "Agent Switched": { "disposition": "IN Progress", "category": "Retry" },
    ...
    "Interested for SV": { "disposition": "Follow Up", "category": "Warm" },
    "Interested in another Project": { "disposition": "Follow Up", "category": "Cold" },
