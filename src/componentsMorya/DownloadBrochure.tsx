...
export default function DownloadBrochureButton() {
    ...
    const [formData, setFormData] = useState<BrochureFormData>({ name: '', email: '', phone: '', source: 'Morya' });
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            link.href = 'pdfs/Morya Brochure.pdf'; // Path in the public folder
            link.download = 'Morya-Brochure.pdf'; // Suggested filename
            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-10 p-6 md:p-20 mb-10">
                ...
                <div className="flex-1">
                    <p className="font-semibold text-gray-600 text-sm md:text-base leading-relaxed">
                        Inspired from the land that fosters fine luxury, Morya located in tollygunge is designed to match the world’s finest luxury apartments while remaining true to our Culture. 
                        A residential marvel that’s filled with the choicest lifestyle features is one of the top condominiums in South Kolkata
