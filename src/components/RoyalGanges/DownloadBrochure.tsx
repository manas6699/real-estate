...
export default function DownloadBrochureButton() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            setFormData({ name: '', email: '', phone: '', source: 'Royal Ganges' });
            setIsOpen(false);

            const link = document.createElement('a');
            link.href = 'pdfs/Primus Ganges Brochure.pdf';
            link.download = 'Primus Ganges Brochure.pdf';
            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-10 p-6 md:p-20 mb-10 bg-yellow-50">
                ...
                <div className="flex-1">
                    <p className="font-semibold text-gray-600 text-sm md:text-base leading-relaxed">
                        Inspired from the land that fosters fine luxury, Royal-Ganges located in Howrah is
